...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btnCount->setGeometry(QRect(50, 70, 80, 24));
        btnReset = new QPushButton(centralwidget);
        btnReset->setObjectName(QString::fromUtf8("btnReset"));
        btnReset->setGeometry(QRect(50, 110, 80, 24));
        labelResult = new QLineEdit(centralwidget);
        labelResult->setObjectName(QString::fromUtf8("labelResult"));
        labelResult->setGeometry(QRect(140, 90, 113, 24));
